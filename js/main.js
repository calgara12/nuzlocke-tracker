var games = {
	'rby': {
		...
		'locations': [
			...
			"Route 7",
			"Celadon City",
			"Celadon Game-Corner 1st",
			"Celadon Game-Corner 2nd",
			"Celadon Game-Corner 3rd",
			"Route 16",
			"Route 17",
			"Route 18",
			"Fuschia City",
	...
	'gsc': {
		...
		'locations': [
			...
			"Route 34",
			"Goldenrod City",
			"Goldenrod Game-Corner 1st",
			"Goldenrod Game-Corner 2nd",
			"Goldenrod Game-Corner 3rd",
			"Route 35",
			"Route 35: Spearow Gift",
			"National Park",
			"Route 36",
			"Route 37",
			"Ecruteak City",
	...
	'rp': {
		...
		'locations': [
			"Starter",
			"Twinleaf Town",
			"Twinleaf Town: Eevee gift",
			"Route 201",
			"Route 201: Mew Encounter",
			"Lake Verity",
			"Verity Cavern: Mesprit Encounter",
			"Sandgem Town: Sinnoh Starter",
			"Sandgem Town: Sinnoh Starter",
			"Route 202",
			"Jubilife City: Egg Gift",
			"Jubilife City: Kanto Starter",
			"Jubilife City: Kanto Starter",
			"Jubilife City: Kanto Starter",
			"Route 203",
			"Oreburgh Gate",
			"Oreburgh Gate: Mewtwo Encounter",
			"Oreburgh City",
			"Oreburgh City: Beldum Gift",
			"Oreburgh City: Hoenn Starter",
			"Oreburgh City: Hoenn Starter",
			"Oreburgh City: Hoenn Starter",
			"Oreburgh Mine",
			"Route 207",
			"Route 204",
			"Ravaged Path",
			"Floaroma Town: Johto Starter",
			"Floaroma Town: Johto Starter",
			"Floaroma Town: Johto Starter",
			"Floaroma Meadow",
			"Route 205",
			"Valley Windworks",
			"Valley Windworks: Zapdos Encounter",
			"Eterna Forest",
			"Eterna Forest: Celebi Encounter",
			"The Old Chateau",
			"The Old Chateau: Gengar Encounter",
			"The Old Chateau: Rotom Encounter",
			"Eterna City",
			"Eterna City: Egg Gift",
			"Eterna City: Porygon Gift",
			"Eterna City: Fossil #1",
			"Eterna City: Fossil #2",
			"Eterna City: Fossil #3",
			"Eterna City: Fossil #4",
			"Eterna City: Fossil #5",
			"Eterna City: Fossil #6",
			"Eterna City: Fossil #7",
			"Eterna City: Fossil #8",
			"Eterna City: Fossil #9",
			"Eterna City: Fossil #10",
			"Eterna City: Fossil #11",
			"Eterna City: Fossil #12",
			"Eterna City: Fossil #13",
			"Eterna City: Fossil #14",
			"Eterna City: Fossil #15",
			"Eterna City: Fossil #16",
			"Eterna City: Fossil #17",
			"Eterna City: Fossil #18",
			"Eterna City: Fossil #19",
			"Route 206",
			"Wayward Cave",
			"Wayward Cave: Gabite Encounter",
			"Mt. Coronet",
			"Mt. Coronet: Articuno Encounter",
			"Mt. Coronet: Regice Encounter",
			"Mt. Coronet: Kyogre Encounter",
			"Route 208",
			"Route 208: Raikou Encounter",
			"Hearthome City",
			"Route 209",
			"Route 209: Spiritomb Encounter",
			"The Lost Tower",
			"The Lost Tower: Ho-oh Encounter",
			"Solaceon Ruins",
			"Solaceon Ruins: Jirachi Encounter",
			"Route 210",
			"Route 215",
			"Veilstone City",
			"Veilstone City: Deoxys Encounter",
			"Route 212",
			"Pokemon Mansion: Manaphy Egg Gift",
			"Trophy Garden",
			"Pastoria City",
			"Pastoria City: Lapras Gift",
			"Great Marsh",
			"Route 213",
			"Route 213: Suicune Encounter",
			"Valor Lakefront",
			"Lake Valor",
			"Valor Cavern: Azelf Encounter",
			"Route 214",
			"Ruin Maniac's Cave",
			"Ruin Maniac's Tunnel",
			"Celestic Town",
			...
			"Routes 219",
			"Route 220",
			"Route 220: Lugia Encounter",
			"Route 221",
			"Route 218",
			"Canalave City",
			"Fullmoon Island: Latias Encounter",
			"Fullmoon Island: Latios Encounter",
			"Fullmoon Island: Cresselia Encounter",
			"Newmoon Island: Darkrai Encounter",
			"Iron Island",
			"Iron Island: Registeel Encounter",
			"Route 211",
			"Route 211: Entei Encounter",
			"Route 216",
			"Route 217",
			"Acuity Lakefront",
			"Lake Acuity",
			"Acuity Cavern: Uxie Encounter",
			"Snowpoint Temple",
			"Snowpoint Temple: Regigigas Encounter",
			"Route 222",
			"Sunyshore City",
			"Route 223",
			"Pokémon League",
			"Pokémon League: Rayquaza Encounter",
			"Victory Road",
			"Victory Road: Moltres Encounter",
			"Route 224",
			"Flower Paradise: Shaymin Encounter",
			"Route 230",
			"Route 229",
			"Resort Area",
			"Route 228",
			"Route 228: Regirock Encounter",
			"Route 226",
			"Route 227",
			"Stark Mountain",
			"Stark Mountain: Groudon Encounter",
			"Stark Mountain: Heatran Encounter",
			"Route 225",
			"Sendoff Spring",
			"Turnback Cave",
			"Distortion World",
			"Distortion World: Giratina Encounter",
			"Spear Pillar",
			"Spear Pillar: Dialga Encounter",
			"Spear Pillar: Palkia Encounter",
			"Newmoon Island",
			"Flower Paradise",
			"Hall of Origin",
			"Hall of Origin: Arceus Encounter"
		]
	},
	'hgss': {
		'id': 'hgss',
	...
	'sgss': {
		'id': 'sgss',
		'title': 'SacredGold and StormSilver',
		'nameLimit': 10,
		'dexLimit': 493,
		'locations': [
			"Starter",
			"New Bark Town",
			"New Bark Town: Rotom Encounter",
			"New Bark Town: Darkrai Encounter",
			"Route 29",
			"Cherrygrove City",
			"Route 30",
			"Route 30: Eevee Gift",
			...
			"Dark Cave",
			"Violet City",
			"Violet City: Mystery-Egg Gift",
			"Violet City: Kanto-Starter Gift",
			"Sprout Tower",
			"Route 32",
			"Ruins of Alph",
			"Union Cave",
			"Union Cave: Lapras Encounter",
			"Route 33",
			"Route 33: Spritomb Encounter",
			"Azalea Town",
			"Azalea Town: Hoenn-Starter Gift",
			"Slowpoke Well",
			"Ilex Forest",
			"Ilex Forest: Celebi",
			"Route 34",
			...
			"Goldenrod Game-Corner 2nd",
			"Goldenrod Game-Corner 3rd",
			"Goldenrod City: Sinnoh-Starter Gift",
			"Goldenrod City: Sinnoh-Starter Gift",
			"Goldenrod City: Sinnoh-Starter Gift",
			"Goldenrod City: Helix-Fossil",
			"Goldenrod City: Dome-Fossil",
			"Goldenrod City: Old-Amber",
			"Goldenrod City: Root-Fossil",
			"Goldenrod City: Claw-Fossil",
			"Goldenrod City: Skull-Fossil",
			"Goldenrod City: Armor-Fossil",
			"Goldenrod City: Castform Gift",
			"Route 35",
			"Route 35: Spearow Gift",
			"National Park",
			"National Park: Shaymin Encounter",
			"Route 36",
			"Route 36: Sudowoodo Encounter",
			"Route 37",
			"Ecruteak City",
			"Burned Tower",
			"Roaming Entei Encounter",
			"Roaming Raikou Encounter",			
			"Bell Tower",
			"Bell Tower: Ho-oh",
			"Route 38",
			"Route 39",
			"Olivine City",
			"Route 40",
			"Route 40: Manaphy-Egg Gift",
			"Route 41",
			"Whirl Islands",
			"Whirl Islands: Lugia Encounter",
			"Cianwood City",
			"Cianwood City: Pikachu Gift",
			"Cianwood City: Shuckle Gift",
			"Cliff Edge Gate",
			"Route 47",
			"Embedded Tower: Groudon Encounter",
			"Embedded Tower: Kyogre Encounter",
			"Embedded Tower: Rayquaza Encounter",
			"Cliff Cave",
			"Route 48",
			"Safari Zone Gate",
			"Safari Zone",
			"Route 42",
			"Mt. Mortar",
			"Mt. Mortar: Tyrogue Gift",
			"Mt. Mortar: Regirock Encounter",
			"Mt. Mortar: Jirachi Encounter",
			"Mahogany Town",
			"Mahogany Town: Riolu Gift",
			"Rocket Hideout",
			"Rocket Hideout: Electrode Encounter",
			"Rocket Hideout: Electrode Encounter",
			"Rocket Hideout: Electrode Encounter",
			"Route 43",
			"Lake of Rage",
			"Lake of Rage: Gyarados Encounter",
			"Route 44",
			"Ice Path",
			"Ice Path: Regice Encounter",
			"Blackthorn City",
			"Dragon's Den",
			"Dragon's Den: Dragonair Gift",
			"Route 45",
			"Dark Cave 2",
			"Dark Cave 2: Registeel Encounter",
			"Route 46",
			"Route 27",
			"Tohjo Falls",
			"Tohjo Falls: Pseudo-Legend Encounter",
			"Route 26",
			"Victory Road",
			"Indigo Plateau",
			"Vermillion City",
			"Roaming Latios Encounter",
			"Roaming Latias Encounter",
			"Route 6",
			"Saffron City",
			"Saffron City: Johto-Starter Gift",
			"Saffron City: Johto-Starter Gift",
			"Route 5",
			"Route 7",
			"Celadon City",
			...
			"Route 8",
			"Route 10",
			"Route 10: Zapdos Encounter",
			"Power Plant",
			"Sinjoh Ruins: Uxie Encounter",
			"Sinjoh Ruins: Mesprit Encounter",
			"Sinjoh Ruins: Azelf Encounter",
			"Sinjoh Ruins: Dialga Encounter",
			"Sinjoh Ruins: Palkia Encounter",
			"Sinjoh Ruins: Giratina Encounter",
			"Rock Tunnel",
			"Route 9",
			"Cerulean City",
			"Route 24",
			"Route 25",
			"Route 25: Suicune Encounter",
			"Route 4",
			"Route 16",
			"Route 17",
			"Route 18",
			...
			"Route 13",
			"Route 12",
			"Route 12: Kanto-Starter Gift",
			"Route 12: Kanto-Starter Gift",
			"Route 11",
			"Route 11: Snorlax Encounter",
			"Diglett's Cave",
			"Route 2",
			"Pewter City",
			"Pewter City: Hoenn-Starter Gift",
			"Pewter City: Hoenn-Starter Gift",
			"Route 3",
			"Route 3: Deoxys",
			"Mt. Moon",
			"Mt. Moon: Cresselia Encounter",
			"Viridian Forest",
			"Viridian Forest: Mew Encounter",
			"Viridian City",
			"Route 1",
			"Pallet Town",
			"Route 21",
			"Cinnabar Island",
			"Cinnabar Island: Heatran Encounter",
			"Cinnabar Gym: Moltres Encounter",
			"Cinnabar Gym: Regigigas Encounter",
			"Seafoam Islands",
			...
			"Mt. Silver",
			"Cerulean Cave",
			"Cerulean Cave: Mewtwo Encounter"
		]
	},
	'bw': {
		'id': 'bw',
	...
	'bbvw': {
		'id': 'bbvw',
		'title': 'Blaze Black and Volt White',
		'nameLimit': 10,
		'dexLimit': 649,
		'locations': [
			"Starter",
			...
			"Pinwheel Forest: Virizion Encounter",
			"Castelia City",
			"Route 4",
			"Desert Resort",
			"Desert Resort: Darmanitan Encounter",
			"Relic Castle",
			"Route 16",
			"Route 5",
			"Driftveil Drawbridge",
			...
			"Route 6",
			"Mistralton Cave",
			"Mistralton Cave: Cobalion Encounter",
			"Chargestone Cave",
			"Route 7",
			"Route 7: Tornadus/Thundurus Encounter",
			"Celestial Tower",
			"Twist Mountain",
			"Iccirus City",
			"Dragonspiral Tower",
			...
			"Route 10",
			"Victory Road",
			"Victory Road: Terrakion Encounter",
			"Route 11",
			"Village Bridge",
			"Route 12",
			"Route 13",
	...
	'slrby': {
		'id': 'slrby',
		'title': 'Soul Link: Red, Blue and Yellow',
		'nameLimit': 10,
		'dexLimit': 151,
		'locations': [
			"Starter",
	...
	'slgsc': {
		'id': 'slgsc',
		'title': 'Soul Link: Gold, Silver and Crystal',
		'nameLimit': 10,
		'dexLimit': 251,
		'locations': [
			"Starter",
	...
	'slrse': {
		'id': 'slrse',
		'title': 'Soul Link: Ruby, Sapphire and Emerald',
		'nameLimit': 10,
		'dexLimit': 386,
		'locations': [
			"Starter",
	...
	'slfrlg': {
		'id': 'slfrlg',
		'title': 'Soul Link: FireRed and LeafGreen',
		'nameLimit': 10,
		'dexLimit': 386,
		'locations': [
			"Starter",
	...
	'sldpp': {
		'id': 'sldpp',
		'title': 'Soul Link: Diamond, Pearl and Platinum',
		'nameLimit': 10,
		'dexLimit': 493,
		'locations': [
			"Starter",
	...
	'slhgss': {
		'id': 'slhgss',
		'title': 'Soul Link: HeartGold and SoulSilver',
		'nameLimit': 10,
		'dexLimit': 493,
		'locations': [
			"Starter",
	...
	'slsgss': {
		'id': 'slsgss',
		'title': 'Soul Link: SacredGold and StormSilver',
		'nameLimit': 10,
		'dexLimit': 493,
		'locations': [
			"Starter",
	...
	'slbw': {
		'id': 'slbw',
		'title': 'Soul Link: Black and White',
		'nameLimit': 10,
		'dexLimit': 649,
		'locations': [
			"Starter",
	...
	'slbw2': {
		'id': 'slbw2',
		'title': 'Soul Link: Black 2 and White 2',
		'nameLimit': 10,
		'dexLimit': 649,
		'locations': [
			"Starter",
	...
	'sloras': {
		'id': 'sloras',
		'title': 'Soul Link: Omega Ruby and Alpha Sapphire',
		'nameLimit': 12,
		'dexLimit': 721,
		'locations': [
			"Starter",
	...
	'slusum': {
		'id': 'slusum',
		'title': 'Soul Link: Ultra Sun and Ultra Moon',
		'nameLimit': 12,
		'dexLimit': 807,
		'locations': [
			"Starter",
